...
screen.textinput("Welcome to Etch-A-Sketch", "WASD keys to move. To turn pen on and off, press 1 and two respectively. Press C to clear. Press enter to continue")
...
screen.onkeypress(key="c", fun= clear1)
